        ...
        <div class="row">
            <div class="col-lg-6 mb-30">
                <div class="about-content">
                    <h2 class="title mb-20">Welcome To variety of shoes</h2>
                    <p class="mb-20">
            ...
            <div class="col-lg-6 mb-30">
                <div class="about-left-image mb-30">
                    <img src="http://localhost:8000/category/1606205175.png"  width="692" height="411" alt="img" class="img-responsive">
                </div>
            </div>
        </div>
