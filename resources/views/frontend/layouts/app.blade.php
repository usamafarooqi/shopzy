    ...
    <div class="inner">
            ...
            <nav class="offcanvas-top-nav">
                <ul class="d-flex justify-content-center align-items-center">
                    <li class="mx-4">
                        ...
                        <div class="dropdown">
                            <i class="icon-user jumbotron-icon icon-4 offcanvas-toggle" style="font-size:2em"  data-toggle="dropdown"></i> 
        ...
        <nav class="offcanvas-menu">
            <ul>
                ...
                <li><a href="{{ route('shop.list') }}"><span class="menu-text">Shop</span></a>
                    <ul class="offcanvas-submenu">
                                        ...
                                        <li><a href="{{ route('checkout.page') }}">Checkout Page</a></li>
                ...
                <li>  
                        ...
                        <li><a href="{{ route('wishlist.page') }}">Wishlist Page</a></li>
                    </ul>
                </li>
...
<div id="offcanvas-wishlist" class="offcanvas offcanvas-wishlist theme1">
    <div class="inner">
        ...
        <ul class="minicart-product-list">
            ...
            @php
               $sub_totals =$items['price'] * $items['quantity']; 
               $totals += $sub_totals;
            @endphp
            <li>
            <a href="{{ route('shop.single',[$id]) }}" class="image">
                    {{-- <img src="{{ asset('frontend/assets/img/product/4.jpg') }}" alt="Cart product Image"> --}}
                    <img  src="{{ asset('storage/'.$items['image']) }}" width="73" height="73"  alt="thumbnail" >
                </a>
                <div class="content">
                    <a href="single-product.html" class="title">{{ $items['name'] }}</a>
                    <span class="quantity-price">1 x <span class="amount">{{ $items['price'] }}</span></span>
                    <a href="{{ route('remove.wishlist',[$id]) }}" class="remove">×</a>
                </div>
            </li>
            @endforeach
            @endif
            ...
            <span class="amount">Rs:{{  $totals }}</span>
            </div> --}}
            {{-- <li>
                <a href="single-product.html" class="image"><img src="{{ asset('frontend/assets/img/product/5.jpg') }}"
            ...
            <li>
                <a href="single-product.html" class="image"><img src="{{ asset('frontend/assets/img/product/6.jpg') }}"
                        alt="Cart product Image"></a>
                <div class="content">
    ...
    <a href="{{ route('wishlist.page') }}" class="btn theme--btn-default btn--lg d-block d-sm-inline-block rounded-5 mt-30">view
            wishlist</a>
    </div>
</div>
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart theme1">
    <div class="inner">
        ...
        <ul class="minicart-product-list">
            <li>
                <a href="single-product.html" class="image"> <img  src="{{ asset('storage/'.$item['image']) }}" width="73" height="73"  alt="thumbnail" ></a>
                ...
                <a href="single-product.html" class="title">{{ $item['name'] }}</a>
                    ...
                    <a href="{{ route('remove',[$id]) }}" class="remove">×</a>
                </div>
                {{-- <div style="float: left"> 
                    <strong>Grand Total :</strong>
                    <span class="amount">Rs:{{  $sub_total }}</span>
                </div> --}}
            </li>
            {{-- <li>
                <a href="single-product.html" class="image"><img src="{{ asset('frontend/assets/img/product/2.jpg') }}"
                        alt="Cart product Image"></a>
                <div class="content">
                    <a href="single-product.html" class="title">Lucky Wooden Elephant</a>
                    <span class="quantity-price">1 x <span class="amount">$35.00</span></span>
            ...
            {{-- <li>
                <a href="single-product.html" class="image"><img src="{{ asset('frontend/assets/img/product/3.jpg') }}"
                        alt="Cart product Image"></a>
                <div class="content">
                    <a href="single-product.html" class="title">Fish Cut Out Set</a>
                    <span class="quantity-price">1 x <span class="amount">$9.00</span></span>
        ...
        <a href="{{ route('cart.page') }}" class="btn theme--btn-default btn--lg d-block d-sm-inline-block rounded-5 mr-sm-2">view
            cart</a>
            ...
            <div class="row align-items-center">
                <div class="col-sm-6 col-lg-2 order-first">
                    <div class="logo text-center text-sm-left mb-30 mb-sm-0">
                        <h1>Shopzy</h1>
                        {{-- <a href="index.html"><img src="{{ asset('frontend/assets/img/logo/logo-dark.jpg') }}" alt="logo"></a> --}}
                    </div>
                </div>
                <div class="col-sm-6 col-lg-5 col-xl-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-sm-end">
                        ...
                        <!-- static-media end -->
                        <div class="cart-block-links theme1 container">
                            <ul class="d-flex justify-content-center align-items-center">
                                <li>
                                   
                                    <div class="dropdown">
                                      <!-- login page this place -->
                                ...
                                <li class="mr-0 cart-block position-relative">
                                    <a class="offcanvas-toggle" href="#offcanvas-cart">
                                        ...
                                        {{-- <span class="badge cbdg1">2</span> --}}
                                        </span>
                                    <span class="cart-total position-relative">Rs:{{ $total }}</span>
                            ...
                            {{-- <ul class="mega-menu row">
                                ...
                                <li class="col-6 mt-4">
                                    <a href="single-product.html" class="zoom-in overflow-hidden"><img
                                            src="{{ asset('frontend/assets/img/mega-menu/1.jpg') }}" alt="img"></a>
                                </li>
                                <li class="col-6 mt-4">
                                    <a href="single-product.html" class="zoom-in overflow-hidden"><img
                                            src="{{ asset('frontend/assets/img/mega-menu/2.jpg') }}" alt="img"></a>
                                </li>
                            </ul> --}}
                        </li>
                        <li>
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-30">
                    <div class="footer-widget mx-w-400">
                        <div class="footer-logo mb-35">
                            <a href="index.html">
                                <img src="{{ asset('frontend/assets/img/logo/logo-dark.jpg') }}" alt="footer logo">
                            </a>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-8 mx-auto col-lg-5 mb-5 mb-lg-0">
                        ...
                        <div class="product-sync-nav">
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)"> <img src="{{ asset('frontend/assets/img/slider/thumb/1.1.jpg') }}"
                                            alt="product-thumb"></a>
                                </div>
                            </div>
                            <!-- single-product end -->
        ...
        <div class="modal-content">
            <div class="modal-header justify-content-center bg-dark">
                <h5 class="modal-title" id="add-to-cartCenterTitle"> <span class="ion-checkmark-round"></span>
                    Product successfully hafiz ahmad added to your shopping cart</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-5 divide-right">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="{{ asset('frontend/assets/img/modal/1.jpg') }}" alt="img">
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="modal-thumb">
                            <img src="{{ asset('frontend/assets/img/single-product/1.2x.jpg') }}" alt="modal-thumb">
